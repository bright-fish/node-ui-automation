...
{
    ComAutoPointer<IUIAutomationElement> pCurrentSelectedItem = NULL;
...
{
    ComAutoPointer<IUIAutomationElement> pFirstSelectedItem = NULL;
...
{
    ComAutoPointer<IUIAutomationElement> pLastSelectedItem = NULL;
