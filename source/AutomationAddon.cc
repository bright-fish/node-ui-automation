...
AutomationAddon::AutomationAddon(Napi::Env env, Napi::Object exports)
{
    ...
    IUIAutomationPropertyIdsWrapperConstructor = IUIAutomationPropertyIdsWrapper::Initialize(env);
    ...
    auto addonDefinition = {
        ...
        InstanceValue("PropertyIDs", IUIAutomationPropertyIdsWrapperConstructor->Value()),
    };
